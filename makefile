...
INC = -I$(COMMON_INCLUDE_DIR) -I$(NETEVENT_INCLUDE_DIR) -I$(LOGGER_INCLUDE_DIR) -I$(FRAME_INCLUDE_DIR) -I$(REDISCLIENT_INCLUDE_DIR) -I$(MONGOC_INCLUDE_DIR) -I$(BSON_INCLUDE_DIR)
